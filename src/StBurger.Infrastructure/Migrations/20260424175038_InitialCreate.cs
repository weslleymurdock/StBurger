...
namespace StBurger.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_OrderId_MenuItemType",
                table: "OrderItems",
                columns: new[] { "OrderId", "MenuItemType" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Orders_Id_Customer_Attendant",
                table: "Orders",
                columns: new[] { "Id", "Customer", "Attendant" },
                unique: true,
                filter: "[Customer] IS NOT NULL AND [Attendant] IS NOT NULL");
        }
